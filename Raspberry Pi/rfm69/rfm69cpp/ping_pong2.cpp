...
int main(int argc, char *argv[])
{
	...
	if(useACK) {
		if(rfm69->sendWithRetry(OTHERNODE, "RADIO 2", 8, 2, 6))
		...
		rfm69->send(OTHERNODE, "RADIO 2", 8, false);
	}
...
void print_usage() {
    printf("    Usage 1: ./ping_pong2 {nodename} \n");
    printf("		- nodename:	Name of the agent node\n");
    printf("		- Defaults:\n");
    printf("			useACK:    TRUE (1)\n");
    printf("\n");

    printf("    Usage 2: ./ping_pong2 {nodename} {useACK} \n");
    printf("		- nodename:	Name of the agent node\n");
